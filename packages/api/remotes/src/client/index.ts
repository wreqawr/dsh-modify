...
import skillsWorkbenchRemote from '@deepseek-ai/dsh-banma-skills-workbench/remote'
...
export type {} from '@deepseek-ai/dsh-banma-skills-workbench/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote, skillsWorkbenchRemote,
    ]) {
